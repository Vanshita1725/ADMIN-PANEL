        ...
        <main className="flex-1 lg:ml-46 bg-gray-100 font-sans text-gray-800">
          <div className="mx-2 md:mx-4">
            ...
            <div className="bg-white shadow-xs mb-6">
              <div className="mb-6 text-white bg-black p-4 md:p-7 pt-10 h-55">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3  p-3">
                ...
                {/* Block Themes Card */}
                <div className="p-3 flex flex-col sm:flex-row gap-4">
                  <div className="h-13 w-16 bg-black flex items-center justify-center !text-white rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              ...
              {/* Right Column */}
              <div className="space-y-6">
                <div id="column3-sortables" className="bg-gray-100 border-dashed border-4 border-gray-300 flex items-center justify-center h-60">
